...
class ImprovedAgent(Player):
    ...
    def handle_sense_result(self, sense_result: List[Tuple[Square, Optional[chess.Piece]]]):
        ...
        if self.color == chess.WHITE:
            ...
            if self.move_number == 2 and self.board.piece_at(chess.parse_square("d3")) is not None:
                print("Abort the knight-king assassination!")
                self.rush = False
    ...
    def choose_move(self, move_actions: List[chess.Move], seconds_left: float) -> Optional[chess.Move]:
        ...
        if (len(self.possible_states) != 0): 
            ...
            self.possible_states.add(self.board)
        ...
        if self.color == chess.WHITE:
            ...
            if self.move_number < len(self.white_move):
                ...
                # Abort the knight king assassination
                if self.rush == False:
                    self.move_number = 10
